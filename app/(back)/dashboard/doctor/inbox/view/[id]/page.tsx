...
export default async function MailDisplay(props: any) { // eslint-disable-line @typescript-eslint/no-explicit-any
            ...
            <div className="flex items-start gap-4 text-sm">
              <Avatar>
                ...
                <AvatarFallback>
                  {mail.senderName
                    .split(" ")
                    .map((chunk: any) => chunk[0]) // eslint-disable-line @typescript-eslint/no-explicit-any
                    .join("")}
                </AvatarFallback>
              </Avatar>
