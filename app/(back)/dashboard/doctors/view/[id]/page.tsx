...
export default async function DoctorDetailsPage(props: any) {
      ...
      <div className="min-h-[50vh] flex items-center justify-center p-4">
        <div className="space-y-4 text-center flex items-center justify-center flex-col max-w-md">
          ...
          <div>
            ...
            <p className="text-slate-600">The doctor profile you're looking for doesn't exist or has been removed.</p>
          </div>
        </div>
      </div>
    );
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 mt-4">
                    {[
                      ...
                      <div key={idx} className="bg-white rounded-lg p-4 border border-slate-200">
                        ...
                        <span className="text-base text-slate-900 font-medium">{value || "Not specified"}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="bg-slate-50 rounded-xl p-4 sm:p-6">
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6 mt-4">
                    <div className="bg-white rounded-lg p-4 border border-slate-200">
                      ...
                      <span className="text-base text-slate-900 font-medium">{doctorProfile?.medicalLicense || "Not provided"}</span>
                    </div>
                    ...
                    <div className="bg-white rounded-lg p-4 border border-slate-200">
                      ...
                      <span className="text-base text-slate-900 font-medium">{doctorProfile?.yearsOfExperience || "Not specified"} years</span>
                    </div>
                  </div>
                  ...
                  <div className="mt-4 bg-white rounded-lg p-4 border border-slate-200">
                    ...
                    <span className="text-base text-slate-900 font-medium">{getNormalDate(expiry as string) || "Not provided"}</span>
                    {doctorProfile?.bio && (
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mt-4">
                    {[
                      ...
                      <div key={idx} className="bg-white rounded-lg p-4 border border-slate-200">
                        ...
                        <span className="text-base text-slate-900 font-medium break-all">{value || "Not provided"}</span>
                      </div>
                    ))}
                  </div>
                </div>
                  ...
                  <div className="mt-6">
                    <div className="bg-white rounded-lg p-4 border border-slate-200 inline-block">
                      ...
                      <span className="text-2xl font-bold text-slate-900">
                        {doctorProfile?.hourlyWage ? `$${doctorProfile.hourlyWage}` : "Not specified"}
                      </span>
                    </div>
                  </div>
              ...
              <TabsContent value="appointments" className="space-y-6">
                {appointments.length > 0 ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-slate-500">This doctor doesn't have any appointments scheduled yet.</p>
                  </div>
                )}
              </TabsContent>
            </Tabs>
